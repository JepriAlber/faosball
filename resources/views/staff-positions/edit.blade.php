    ...
    <div class="card">
        ...
        <div class="card-header">
            <div>
                ...
                <p class="card-description">{{ __('Perbarui detail jabatan staff.') }}</p>
            </div>
        ...
        <form action="{{ route('staff-positions.update', $staffPosition) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $staffPosition->name) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" value="{{ old('code', $staffPosition->code) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="3" placeholder="{{ __('Keterangan singkat tentang jabatan ini') }}"
                            class="form-textarea @error('description') form-danger @enderror">{{ old('description', $staffPosition->description) }}</textarea>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="role_id" class="form-select @error('role_id') form-danger @enderror">
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" @selected((string) old('role_id', $staffPosition->role_id) === (string) $role->id)>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group"
                        x-data="{ isCoach: {{ old('is_coach', $staffPosition->is_coach) ? 'true' : 'false' }} }">
                    ...
                    <div class="form-group"
                        x-data="{ isActive: {{ old('status', $staffPosition->status) ? 'true' : 'false' }} }">
