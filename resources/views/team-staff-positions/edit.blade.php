    ...
    <div class="card">
        ...
        <div class="card-header">
            <div>
                ...
                <p class="card-description">{{ __('Perbarui detail peran staff tim.') }}</p>
            </div>
        ...
        <form action="{{ route('team-staff-positions.update', $teamStaffPosition) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                ...
                <div>
                    ...
                    @if ($isSuperAdmin)
                        <div class="form-group">
                            ...
                            <p class="form-input bg-gray-50 dark:bg-gray-800">
                                {{ $teamStaffPosition->academy->name }}
                            </p>
                        </div>
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $teamStaffPosition->name) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" value="{{ old('code', $teamStaffPosition->code) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="3" placeholder="{{ __('Keterangan singkat tentang peran ini') }}"
                            class="form-textarea @error('description') form-danger @enderror">{{ old('description', $teamStaffPosition->description) }}</textarea>
                ...
                <div>
                    ...
                    <div class="form-group"
                        x-data="{ isActive: {{ old('status', $teamStaffPosition->status) ? 'true' : 'false' }} }">
