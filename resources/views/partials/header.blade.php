<header x-data="{ menuToggle: false }" class="app-header">
    <div class="app-header-inner">
        ...
        <div class="app-header-topbar">
            ...
            <button class="header-hamburger-btn"
                ...
                {{-- Hamburger: mobile (sidebar tertutup) --}}
            ...
            {{--
                Logo tengah: hanya tampil di mobile (lg:hidden).
                Header selalu menampilkan logo di mobile — tidak disembunyikan
            ...
            <!-- Tombol ... (mobile) -->
            <button class="header-menu-btn" :class="menuToggle ? 'bg-gray-100' : ''"
        ...
        <!-- ===== Action bar (dark mode, notif, user) ===== -->
        <div :class="menuToggle ? 'flex' : 'hidden'"
            class="app-header-actionbar lg:flex lg:justify-end lg:px-0 lg:shadow-none">
            <div class="flex items-center gap-2 2xsm:gap-3">

                <!-- Dark Mode Toggler -->
                <button class="header-icon-btn-circle" @click.prevent="darkMode = !darkMode">
                ...
                <div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    <button class="header-icon-btn-circle"
                        @click.prevent="dropdownOpen = !dropdownOpen; notifying = false">
                        <span :class="!notifying ? 'hidden' : 'flex'" class="notif-dot">
                    ...
                    <div x-show="dropdownOpen"
                        class="header-dropdown-panel -right-[240px] h-[480px] w-[350px] sm:w-[361px] lg:right-0">
                        <div class="header-dropdown-header">
                            <h5 class="text-lg font-semibold text-gray-800">Notifikasi</h5>
                        ...
                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                            {{-- Isi notifikasi dinamis di sini --}}
                            {{-- Contoh item notifikasi:
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5" href="#">
                                <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                    <img src="{{ asset('assets/images/user/user-02.jpg') }}" alt="User" class="overflow-hidden rounded-full" />
                                ...
                                <span class="block">
                                    ...
                                    <span class="font-medium text-gray-800 dark:text-white/90">Nama User</span>
                                    melakukan aksi pada
                                    <span class="font-medium text-gray-800 dark:text-white/90">Nama Item</span>
                                    </span>
                        ...
                        <a href="#" class="header-dropdown-footer-link">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="header-user-trigger" href="#" @click.prevent="dropdownOpen = !dropdownOpen">
                    ...
                    <svg :class="dropdownOpen ? 'rotate-180' : ''" class="header-dropdown-arrow" width="18"
                ...
                <!-- User Dropdown Menu -->
                <div x-show="dropdownOpen" class="header-dropdown-panel right-0 w-[260px]">
                    ...
                    <ul class="header-dropdown-list">
                        <li>
                            <a href="#" class="header-dropdown-item group">
                                <svg class="header-dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="header-dropdown-item group mt-3 w-full">
                            <svg class="header-dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
