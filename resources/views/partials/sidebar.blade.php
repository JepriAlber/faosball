<aside
  ...
  class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 transition-all duration-300 ease-linear dark:border-gray-800 dark:bg-black lg:static"
>
  <!-- SIDEBAR HEADER -->
  <div
    :class="sidebarToggle ? 'lg:justify-center' : 'justify-start'"
  ...
  >
    <a href="{{ route('dashboard') }}">
      ...
      <img
        ...
        src="{{ asset('assets/images/logo/kantinit-favicon.png') }}"
        alt="Logo"
      />
    </a>
  </div>
      ...
      <div class="mb-6">
        ...
        <ul class="flex flex-col gap-4">
          ...
          <li x-data="{ open: {{ $isDashboardActive ? 'true' : 'false' }} }">
            ...
            >
              <svg
                :class="open ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                ...
                :class="[open ? 'menu-item-arrow-active rotate-180' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '']"
              ...
              >
                <li>
                  <a
                    ...
                    :class="{{ Route::is('dashboard') ? 'true' : 'false' }} ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                  >
                    Ringkasan
                  </a>
                </li>
          ...
          <li>
            ...
            >
              <svg
                class="{{ $isProfileActive ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
              >
