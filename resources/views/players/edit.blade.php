            ...
            <div class="form-row">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="primary_position"
                            value="{{ old('primary_position', $player->primary_position) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="secondary_position"
                            value="{{ old('secondary_position', $player->secondary_position) }}" class="form-input">
                    </div>
