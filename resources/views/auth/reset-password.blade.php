    ...
    <div class="relative flex flex-col justify-center w-full min-h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="{{ old('email', $request->email) }}" required readonly
                            class="h-11 w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-white/90" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" required
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                    </div>
        ...
        <div
            ...
            <div class="relative flex flex-col items-center justify-center w-full px-16 text-center z-10">
                ...
                <p class="text-blue-200 text-lg font-medium mb-3">Account Recovery System</p>
                <p class="text-blue-300/80 text-sm leading-relaxed max-w-sm mx-auto">
                    Pulihkan akses akun Anda dengan aman dan cepat dalam sistem FAoSBall.
                </p>
