...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div>
                <h3 class="card-title">Player Category List</h3>
                <p class="card-description">Manajemen kelompok umur (U-12, U-15, U-17, dsb) per academy.</p>
            </div>
            ...
            <table class="table">
                ...
                <thead class="table-head">
                    <tr class="table-header-row">
                        ...
                        @endif
                        <th class="table-header-cell">Rentang Umur</th>
                ...
                <tbody class="table-body">
                    ...
                    @forelse ($playerCategories as $playerCategory)
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-cell">
                                <span class="table-text">{{ $playerCategory->players_count }} Player</span>
                            </td>
                                ...
                                <div class="table-action">
                                    ...
                                    @can('player_category.delete')
                                        <x-button.delete :action="route('player-categories.destroy', $playerCategory)"
                                            ...
                                            reason="Kategori masih digunakan oleh player, tidak dapat dihapus." />
                                    @endcan
                        ...
                        <tr>
                            <td colspan="{{ $isSuperAdmin ? 6 : 5 }}" class="table-empty">
                                <div class="empty-state">
                                    ...
                                    <h4 class="empty-title">Belum ada Player Category</h4>
                                    <p class="empty-description">Tambahkan player category pertama.</p>

                                    @can('player_category.create')
                                        <a href="{{ route('player-categories.create') }}" class="empty-link">Tambah
                                            Player Category</a>
                                    @endcan
                ...
                <div class="table-card">
                    ...
                    <div class="table-card-body">
                        <div class="table-card-field">
                            <span class="table-card-label">Rentang Umur</span>
                            <span class="table-text">{{ $playerCategory->min_age }}–{{ $playerCategory->max_age }}
                                tahun</span>
                        </div>
            ...
            @empty
                <div class="table-card">
                    <div class="empty-state">
                        ...
                        @can('player_category.create')
                            <a href="{{ route('player-categories.create') }}" class="empty-link">Tambah Player
                                Category</a>
                        @endcan
                    </div>
                </div>
